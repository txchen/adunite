...
module.exports = {
  ...
  setSharedPref: function (prefName, prefDict, resultCallback, errorCallback) {
    cordova.exec(resultCallback, errorCallback, 'Intenthelper', 'setSharedPref', [prefName, prefDict])
  },
